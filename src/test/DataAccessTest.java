...
public class DataAccessTest {
	...
	public void registerTest0() {
		User u = new User("aa", "aa", "aa", "Prueba", "Prueba", "aa", "aa", "aa", "aa", "aa", "aa", "aa", "aa", "aa");
		try {
	...
	@Test
	// Usuario desberdina, langilea false da, erregistratuko da eta true itzuliko du
	...
	@Test
	// Usuario desberdina, langilea true da, erregistratuko da eta true itzuliko du
	...
	public void registerTest4() {
		...
		try {
			// testBL.register(u);
			sut.Register(false, null, "aa", "aa", "Gsddrka", "1asd23", "aa", "aa", "aa", "aa", "aa", "aa", "aa", "aa",
					"aa");
			// System.out.println(aa+"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
			fail();
			...
			try {
				boolean b = testBL.removeUser(testBL.getUser("Gsddrka"));
				System.out.println("Finally " + b);
			} catch (Exception e2) {
				System.out.println(e2);
			}
	...
	public void registerTest9() {
		try {
			...
			System.out.println(e + "aaaaaaaaaaaaaaaaaaaaa");
			assertTrue(true);
		} finally {
			try {
				boolean b = testBL.removeUser(testBL.getUser("1234"));
